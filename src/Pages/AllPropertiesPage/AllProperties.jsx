...
const AllProperties = () => {
  ...
  return (
      <div className="mx-10 my-10">
         ...
         <form action="" >
            <input type="text" name="property" placeholder="Property Name" className="w-1/3 border-2 border-pink-700 p-4 rounded-l-lg"/>
         ...
         <button className="w-[150px]  border-y-2 border-r-2 bg-pink-800 border-pink-700 rounded-lg font-bold text-white"> Price Filter </button>
         </div>
          {
